...
import 'package:club_droid/chatMessageListItem.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  CupertinoButton getAndroidSendButton() {
              ...
              new Container(
                ...
                child: new IconButton(
                    ...
                    onPressed: () async {
                      ...
                      File pickedFile = (await picker.getImage(
                      ...
                      StorageUploadTask uploadTask = firebaseStorageRef
                          .putFile(pickedFile) as StorageUploadTask;
